...
namespace DotNetNuke.Authentication.Cas.Components
{
    public static class CASHelper
    {
        ...
        /// </summary>
        public static void LoginAndRedirect(Action<string, bool> onComplete)
        {
            string returnUrl = Login(onComplete);
        ...
        /// </summary>
        public static string Login(Action<string, bool> onComplete)
        {
